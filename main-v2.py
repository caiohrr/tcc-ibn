...
class MininetScriptGenerator:
    ...
    def _write_intent_monitoring(self, file, topology):
        ...
        file.write("\t\t\tself.id = data['id']\n")
        file.write("\t\t\tself.version = data['version']\n")
        file.write("\t\t\tself.description = data['description']\n")
        file.write("\t\t\tself.hosts = data['hosts']\n")
        file.write("\t\t\tself.switches = data['switches']\n")
        file.write("\t\t\tself.controllers = data['controllers']\n")
        file.write("\t\t\tself.connections = data['connections']\n\n")
