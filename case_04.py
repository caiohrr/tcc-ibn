...
Topology: Six_hosts_one_switch_monitored
Version: 1.0
Description: A network with 6 hosts connected to a single switch, with monitoring enabled for connectivity.
...
def six_hosts_one_switch_monitored_topology():
	...
	topology_data = {
		'id': 'six_hosts_one_switch_monitored',
		'version': '1.0',
		'description': 'A network with 6 hosts connected to a single switch, with monitoring enabled for connectivity.',
		'hosts': [
...
if __name__ == '__main__':
	setLogLevel('info')
	six_hosts_one_switch_monitored_topology()
