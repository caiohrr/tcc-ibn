...
Topology: Remote_controller_net
Version: 1.0
Description: A simple network with a remote controller, one switch, and two hosts.
...
def remote_controller_net_topology():
...
if __name__ == '__main__':
	setLogLevel('info')
	remote_controller_net_topology()
