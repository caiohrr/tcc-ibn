...
Topology: Two_switches_two_hosts
Version: 1.0
Description: Topology with two switches (s1, s2) and two hosts (h1, h2). h1 connects to s1, h2 connects to s2, and s1 connects to s2.
...
def two_switches_two_hosts_topology():
...
if __name__ == '__main__':
	setLogLevel('info')
	two_switches_two_hosts_topology()
