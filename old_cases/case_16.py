...
Topology: Simple_h1_s1_link
Version: 1.0
Description: A simple topology with one host h1 connected to one switch s1 with a 1000Mbps link.
...
def simple_h1_s1_link_topology():
	...
	topology_data = {
		'id': 'simple_h1_s1_link',
		'version': '1.0',
		'description': 'A simple topology with one host h1 connected to one switch s1 with a 1000Mbps link.',
		'hosts': [
			{'id': 'h1', 'ip': '192.168.0.5/24', 'mac': None},
		],
		'switches': [
			{'ID': 's1'},
		],
		...
		'connections': [
			{'ENDPOINTS': ['h1', 's1'], 'PARAMS': {'BANDWIDTH': 1000}},
		]
	}
