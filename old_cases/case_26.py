...
Topology: H1_h2_s1_remote_controller
Version: 1.0
Description: A simple topology with two hosts connected to a switch, managed by a remote controller, with monitoring and recovery enabled.
...
def h1_h2_s1_remote_controller_topology():
...
if __name__ == '__main__':
	setLogLevel('info')
	h1_h2_s1_remote_controller_topology()
