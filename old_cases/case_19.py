...
Topology: Simple_h1_h2_net
Version: 1.0
Description: A basic network with two hosts (h1, h2) connected to a single switch, all links with 100Mbps bandwidth.
