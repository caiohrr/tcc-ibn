...
Topology: Three_hosts_to_one_switch
Version: 1.0
Description: Three hosts connected to a single switch.
...
def three_hosts_to_one_switch_topology():
...
if __name__ == '__main__':
	setLogLevel('info')
	three_hosts_to_one_switch_topology()
