...
Topology: Simple_latency_net
Version: 1.0
Description: Network with h1 and h2, each with specific link latencies.
...
def simple_latency_net_topology():
	...
	topology_data = {
		...
		'connections': [
			{'ENDPOINTS': ['h1', 's1'], 'PARAMS': {'DELAY': '20ms'}},
