...
Topology: Memory_limited_host_net
Version: 1.0
Description: A simple network with h1 connected to s1, h1 has a memory limit.
...
def memory_limited_host_net_topology():
	...
	topology_data = {
		'id': 'memory_limited_host_net',
		'version': '1.0',
		'description': 'A simple network with h1 connected to s1, h1 has a memory limit.',
		'hosts': [
			{'id': 'h1', 'ip': None, 'mac': None, 'max_ram': 512},
		],
		'switches': [
			{'ID': 's1'},
		],
...
if __name__ == '__main__':
	setLogLevel('info')
	memory_limited_host_net_topology()
