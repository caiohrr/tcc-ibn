...
Topology: Ten_hosts_two_subnets
Version: 1.0
Description: A network with 10 hosts connected to a single switch, split into two subnets.
...
def ten_hosts_two_subnets_topology():
	...
	h6 = net.addHost('h6', ip='10.0.2.1/24')
	h7 = net.addHost('h7', ip='10.0.2.2/24')
	h8 = net.addHost('h8', ip='10.0.2.3/24')
	h9 = net.addHost('h9', ip='10.0.2.4/24')
	h10 = net.addHost('h10', ip='10.0.2.5/24')
	...
	topology_data = {
		'id': 'ten_hosts_two_subnets',
		'version': '1.0',
		'description': 'A network with 10 hosts connected to a single switch, split into two subnets.',
		'hosts': [
			{'id': 'h1', 'ip': '10.0.1.1/24', 'mac': None},
			{'id': 'h2', 'ip': '10.0.1.2/24', 'mac': None},
			{'id': 'h3', 'ip': '10.0.1.3/24', 'mac': None},
			{'id': 'h4', 'ip': '10.0.1.4/24', 'mac': None},
			{'id': 'h5', 'ip': '10.0.1.5/24', 'mac': None},
			{'id': 'h6', 'ip': '10.0.2.1/24', 'mac': None},
			{'id': 'h7', 'ip': '10.0.2.2/24', 'mac': None},
			{'id': 'h8', 'ip': '10.0.2.3/24', 'mac': None},
			{'id': 'h9', 'ip': '10.0.2.4/24', 'mac': None},
			{'id': 'h10', 'ip': '10.0.2.5/24', 'mac': None},
		],
		'switches': [
			{'ID': 's1'},
		],
...
if __name__ == '__main__':
	setLogLevel('info')
	ten_hosts_two_subnets_topology()
