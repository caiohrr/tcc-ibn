...
Topology: Dual_switch_topology
Version: 1.0
Description: Topology with two switches (s1, s2) and six hosts (h1-h6), with a high-speed link between switches.
...
def dual_switch_topology_topology():
	...
	topology_data = {
		...
		'connections': [
			...
			{'ENDPOINTS': ['h5', 's2']},
			{'ENDPOINTS': ['h6', 's2']},
			{'ENDPOINTS': ['s1', 's2'], 'PARAMS': {'BANDWIDTH': 1000}},
		]
	}
