...
Topology: Twenty_hosts_single_switch
Version: 1.0
Description: A network with 20 hosts connected to a single switch, with varying delays.
...
def twenty_hosts_single_switch_topology():
	...
	net.addLink(h4, s1, delay='5ms')
	net.addLink(h5, s1, delay='5ms')
	net.addLink(h6, s1, delay='5ms')
	net.addLink(h7, s1, delay='5ms')
	net.addLink(h8, s1, delay='5ms')
	net.addLink(h9, s1, delay='5ms')
	net.addLink(h10, s1, delay='5ms')
	net.addLink(h11, s1, delay='50ms')
	net.addLink(h12, s1, delay='50ms')
	net.addLink(h13, s1, delay='50ms')
	net.addLink(h14, s1, delay='50ms')
	net.addLink(h15, s1, delay='50ms')
	net.addLink(h16, s1, delay='50ms')
	net.addLink(h17, s1, delay='50ms')
	net.addLink(h18, s1, delay='50ms')
	net.addLink(h19, s1, delay='50ms')
	net.addLink(h20, s1, delay='50ms')
	...
	topology_data = {
		...
		'connections': [
			{'ENDPOINTS': ['h1', 's1'], 'PARAMS': {'DELAY': '5ms'}},
			{'ENDPOINTS': ['h2', 's1'], 'PARAMS': {'DELAY': '5ms'}},
			{'ENDPOINTS': ['h3', 's1'], 'PARAMS': {'DELAY': '5ms'}},
			{'ENDPOINTS': ['h4', 's1'], 'PARAMS': {'DELAY': '5ms'}},
			{'ENDPOINTS': ['h5', 's1'], 'PARAMS': {'DELAY': '5ms'}},
			{'ENDPOINTS': ['h6', 's1'], 'PARAMS': {'DELAY': '5ms'}},
			{'ENDPOINTS': ['h7', 's1'], 'PARAMS': {'DELAY': '5ms'}},
			{'ENDPOINTS': ['h8', 's1'], 'PARAMS': {'DELAY': '5ms'}},
			{'ENDPOINTS': ['h9', 's1'], 'PARAMS': {'DELAY': '5ms'}},
			{'ENDPOINTS': ['h10', 's1'], 'PARAMS': {'DELAY': '5ms'}},
			{'ENDPOINTS': ['h11', 's1'], 'PARAMS': {'DELAY': '50ms'}},
			{'ENDPOINTS': ['h12', 's1'], 'PARAMS': {'DELAY': '50ms'}},
			{'ENDPOINTS': ['h13', 's1'], 'PARAMS': {'DELAY': '50ms'}},
			{'ENDPOINTS': ['h14', 's1'], 'PARAMS': {'DELAY': '50ms'}},
			{'ENDPOINTS': ['h15', 's1'], 'PARAMS': {'DELAY': '50ms'}},
			{'ENDPOINTS': ['h16', 's1'], 'PARAMS': {'DELAY': '50ms'}},
			{'ENDPOINTS': ['h17', 's1'], 'PARAMS': {'DELAY': '50ms'}},
			{'ENDPOINTS': ['h18', 's1'], 'PARAMS': {'DELAY': '50ms'}},
			{'ENDPOINTS': ['h19', 's1'], 'PARAMS': {'DELAY': '50ms'}},
			{'ENDPOINTS': ['h20', 's1'], 'PARAMS': {'DELAY': '50ms'}},
		]
	}
...
if __name__ == '__main__':
	setLogLevel('info')
	twenty_hosts_single_switch_topology()
