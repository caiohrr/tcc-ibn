...
Topology: Star_topology_8_hosts
Version: 1.0
Description: A star topology with one central switch (s1) and 8 hosts (h1-h8) connected to it, all with 100Mbps bandwidth.
...
def star_topology_8_hosts_topology():
...
if __name__ == '__main__':
	setLogLevel('info')
	star_topology_8_hosts_topology()
