...
Topology: Voip_simulation_14_hosts
Version: 1.0
Description: VoIP simulation with 14 hosts connected to a single switch. Odd hosts have 1ms delay, even hosts have 20ms delay (simulated jitter).
...
def voip_simulation_14_hosts_topology():
	...
	info('*** Creating 14 links\n')
	net.addLink(h1, s1, delay='1ms')
	net.addLink(h2, s1, delay='20ms')
	net.addLink(h3, s1, delay='1ms')
	net.addLink(h4, s1, delay='20ms')
	net.addLink(h5, s1, delay='1ms')
	net.addLink(h6, s1, delay='20ms')
	net.addLink(h7, s1, delay='1ms')
	net.addLink(h8, s1, delay='20ms')
	net.addLink(h9, s1, delay='1ms')
	net.addLink(h10, s1, delay='20ms')
	net.addLink(h11, s1, delay='1ms')
	net.addLink(h12, s1, delay='20ms')
	net.addLink(h13, s1, delay='1ms')
	net.addLink(h14, s1, delay='20ms')
	...
	topology_data = {
		...
		'connections': [
			{'ENDPOINTS': ['h1', 's1'], 'PARAMS': {'DELAY': '1ms'}},
			{'ENDPOINTS': ['h2', 's1'], 'PARAMS': {'DELAY': '20ms'}},
			{'ENDPOINTS': ['h3', 's1'], 'PARAMS': {'DELAY': '1ms'}},
			{'ENDPOINTS': ['h4', 's1'], 'PARAMS': {'DELAY': '20ms'}},
			{'ENDPOINTS': ['h5', 's1'], 'PARAMS': {'DELAY': '1ms'}},
			{'ENDPOINTS': ['h6', 's1'], 'PARAMS': {'DELAY': '20ms'}},
			{'ENDPOINTS': ['h7', 's1'], 'PARAMS': {'DELAY': '1ms'}},
			{'ENDPOINTS': ['h8', 's1'], 'PARAMS': {'DELAY': '20ms'}},
			{'ENDPOINTS': ['h9', 's1'], 'PARAMS': {'DELAY': '1ms'}},
			{'ENDPOINTS': ['h10', 's1'], 'PARAMS': {'DELAY': '20ms'}},
			{'ENDPOINTS': ['h11', 's1'], 'PARAMS': {'DELAY': '1ms'}},
			{'ENDPOINTS': ['h12', 's1'], 'PARAMS': {'DELAY': '20ms'}},
			{'ENDPOINTS': ['h13', 's1'], 'PARAMS': {'DELAY': '1ms'}},
			{'ENDPOINTS': ['h14', 's1'], 'PARAMS': {'DELAY': '20ms'}},
		]
	}
...
if __name__ == '__main__':
	setLogLevel('info')
	voip_simulation_14_hosts_topology()
